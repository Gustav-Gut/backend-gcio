"""
Django settings for gcioMicroservices project.
...
ROOT_URLCONF = 'gcioMicroservices.urls'
...
WSGI_APPLICATION = 'gcioMicroservices.wsgi.application'
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': os.environ.get('SECRET_KEY_JWT', SECRET_KEY),
    'AUTH_HEADER_TYPES': ('Bearer',),
}

# Configuración del backend de autenticación (si necesitas custom)
AUTHENTICATION_BACKENDS = [
    'authentication.backends.CustomAuthBackend',  # nuestro backend custom
